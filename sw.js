const CACHE = 'tcg-scout-v1-3';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./backend.js','./supabase-config.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
